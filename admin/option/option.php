...
return array(
	'title' => __('Ammarath Option Panel', 'vp_textdomain'),
	'logo' => '',
	'menus' => array(
...
array(
	...
	'controls' => array(
		array(
			'type' => 'section',
			'title' => __('Look And Feel', 'vp_textdomain'),
			'fields' => array(
								array(
					'type' => 'color',
					'name' => 'cl_2',
					'label' => __('Section Color', 'vp_textdomain'),
		...
		array(
			'title' => __('Homepage Options', 'vp_textdomain'),
			'name' => 'menu_1',
			...
			'menus' => array(
				array(
					...
					'controls' => array(
						array(
							'type' => 'section',
							'title' => __('Homepage Sliders', 'vp_textdomain'),
							'name' => 'sliders',
...
array(
	...
	'controls' => array(
		array(
			'type' => 'section',
			'title' => __('Choose Layouts', 'vp_textdomain'),
			'fields' => array(
				array(
					'type' => 'radioimage',
					'name' => 'blog_layout',
					'label' => __('Choose Blog layout', 'vp_textdomain'),
					'description' => __('Check the layout you want your blogs post to be displayed with', 'vp_textdomain'),
					'items' => array(
						array(
							'value' => 'one',
							'label' => __('Layout 1', 'vp_textdomain'),
							'img' => get_template_directory_uri() . '/images/blog_one.jpg',
							),
						array(
							'value' => 'two',
							'label' => __('Layout 2', 'vp_textdomain'),
							'img' => get_template_directory_uri() . '/images/blog_two.jpg',
							),
						),
					'default' => array(
						'one',
...
array(
	...
	'controls' => array(
		array(
			'type' => 'section',
			'title' => __('Typography with Preview', 'vp_textdomain'),
			'fields' => array(
				array(
					'type' => 'html',
